...
class AoC17a {
	...
	private AoC17a() throws Exception {
	...
	void check(String passCode) throws Exception {
		...
		while (!q.isEmpty() && !found){
			...
			if (m.x == 3 && m.y == 3){
				System.out.println(passCode + ": " + m.passCode.substring(passCode.length()));
				found = true;
				break;
			} 
		}
		...
		if (!found){
			System.out.println("No route: " + passCode);
		}
	}
	
	public static void main(String[] args) throws Exception{
		System.out.println("AoC17a");
		new AoC17a().run();
	}
}